                                    ...
                                    <div className="journey-history-card-child">
                                        <div className="card-sub-child">
                                            <div className="card-date">
                                                <p>{moment(data?.createdAt).format("YYYY-MM-DD | h:mm A")}</p>
                                            </div>
                                            <div className="card-status">
                                                <button className={data?.status === "pending" ? "bg-pending" : "bg-completed"}>{data?.status}</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="journey-history-card-child">
...

                                            {
                                                data?.status === "completed"
                                                    ...
                                                    <div className="submit-btn">
                                                        <Link href="/dashboard/booking/submitJourney">
